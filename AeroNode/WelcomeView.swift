...
/// A welcome and setup view that guides the user through the initialization of the underlying backend services.
        ...
        VStack(spacing: 24) {
            ...
            case .missingDocker:
                statusView(
                    ...
                    message: "Please start Docker Desktop to proceed."
                )
            ...
            case .needsPull:
                VStack(spacing: 16) {
                    statusView(
                        ...
                        message: "Ready to download the simulation core."
                    )
            ...
            case .readyToStart:
                VStack(spacing: 16) {
                    statusView(
                        ...
                        color: .green,
                        title: "System Ready",
                        message: "All components are verified and cached."
                    )
